               ...
               <?php
                   ...
                   // echo"<pre>";print_r ($array_MateriaPrima);echo"<pre>";
                    ...
                    foreach ($array_MateriaPrima as $key => $value) {
                       ...
                       echo "<td><a href='index.php?view=editMatPrima&id=$id' class='btn btn-info btn-sm'><i class='fa fa-eye'></i></a>
                       <a href='index.php?action=deleteMateriaPrima&id=$id'class='btn btn-warning btn-sm'><i class='fa fa-eraser'></i></a>
                       </td>";

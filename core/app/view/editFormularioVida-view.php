			...
			?>
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						...
						<input type="text" value="<?php echo $arrayform["altura"] ?>" class="form-control" size="6" name="altura" id="altura">
				...
				<div class="form-group">
					...
					<div class="col-sm-7">
						...
						<input type="text" value="<?php echo $arrayform["peso"] ?>" class="form-control"name="peso" id="peso" >
				...
				<div class="form-group">
					...
					<div class="col-sm-7"> 
						...
						<input type="text" value="<?php echo $arrayform["temperatura"] ?>" class="form-control" name="temperatura" id="temperatura" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3"> 
						...
						<input type="text" value="<?php echo $arrayform["frecuencia_cardiaca"] ?>" class="form-control" name="frec_cardiaca" id="frec_cardiaca" >
					...
					<div class="col-sm-3">
						...
						<input type="text" value="<?php echo $arrayform["precion_arterial"] ?>" class="form-control" name ="prec_arterial" id="prec_arterial" maxlength="6" >
				...
				<div class="form-group"> 
					...
					<div class="col-sm-offset-2 col-sm-10">
						...
						<button type="submit" class="btn btn-primary btn-md">Guardar Modificaciones</button>
						<?php 
